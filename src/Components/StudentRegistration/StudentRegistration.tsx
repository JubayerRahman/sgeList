...
function StudentRegistration() {
    ...
    const fetchStudentData = async () => {
        ...
        const noteFunction = async (e: any, id: string) => {
            ...
            try {
                const response = await axios.patch(`${import.meta.env.VITE_Students}/${id}`, {newNote: note});
        ...
        const statusFunction = async (e: any, id: string) => {
            ...
            try {
                const response = await axios.patch(`${import.meta.env.VITE_Students}/${id}`, {newStatus: Stauts});
