      ...
      const [selectedId, setSelectedId] = useState<string>()
        ...
        if (error) {
            ...
            const noteFunction = async (e: any, id: string) => {
                ...
                try {
                    const response = await axios.patch(`${import.meta.env.VITE_APPLICATION}/${id}`, {newNote: note});
            ...
            const statusFunction = async (e: any, id: string) => {
                ...
                try {
                    const response = await axios.patch(`${import.meta.env.VITE_APPLICATION}/${id}`, {newStatus: Stauts});
