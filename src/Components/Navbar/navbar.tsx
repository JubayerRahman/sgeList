...
function Navbar() {
  return (
    <div className='w-fit md:w-[20%] md:sticky md:top-2.5'>
        <ul className='flex border-2 md:border-0 rounded-md border-b-0 rounded-b-none  flex-row mt-[-46px] bg-white md:mt-0 md:flex-col  justify-between ml-[-12px] md:ml-0 '>
